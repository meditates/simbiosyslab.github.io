...
<div class="ui four centered doubling cards" style="padding:25px;">
 ...
 <a href="https://www.mathcs.emory.edu/~rkarimi/" class="fluid card">
    <div class="image">
      <img style="width:100px; height:100px; margin-top:10px; margin-bottom: 20px; margin-left-auto; margin-right:auto; border-radius: 100% !important" src="../resources/profiles/reza.jpg"/>
    </div>
    <div class="content">
   ...
   <a href="http://www.gchockler.com/" class="fluid card">
    <div class="image">
      <img style="width:100px; height:100px;  margin-top:10px; margin-bottom: 20px; margin-left-auto; margin-right:auto; border-radius: 100% !important" src="https://pure.royalholloway.ac.uk/portal/files/10508164/me.jpg"/>
    </div>
    <div class="content">
   ...
   <a href="https://ymsir.com" class="fluid card">
    <div class="image">
      <img style="width:100px; height:100px;  margin-top:10px; margin-bottom: 20px; margin-left-auto; margin-right:auto; border-radius: 100% !important" src="../resources/profiles/ymir.jpg"/>
    </div>
    <div class="content">
